    ...
    configMap = {
      main_html : String()
        + '<div style="width: 100%; left: 0; position: absolute;">'
          + '<img style="width: 100%; height: 300px;" src="gz/bg.jpg">'
        + '</div>'
        + '<div class="zx-home row">'
          + '<div id="sitelink" class="col-sm-12"><a style="color: blue;" href="http://hz.zxsl.net.cn/">杭州站</a> . <a style="color: blue;" href="http://sz.zxsl.net.cn/">深圳站</a> . <span style="color: green;">您现在位于广州站</span></div>'
          + '<div class="col-md-6 col-md-offset-3 col-xs-12" style="text-align: center; margin-top: 300px;">'
            //+ '<h1 style="color: #ffdd66; font-family: 微软雅黑;"><small style="color: #ffdd66; font-family: 微软雅黑;">2016年5月30日前，</small>广州站 <small style="color: #ffdd66; font-family: 微软雅黑;">免收送机费</small></h1>'
            + '<div style="text-align: left;">'
              + '<h4 style="color: #ffdd66; font-family: 微软雅黑;">我们秉承“让客户安心，让客人顺心”的工作原则。一心一意的做好机场服务工作，做您的机场小帮手！</h4>'
              + '<table style="color: white;">'
                + '<tr>'
                  + '<td>广州分部负责人：</td>'
                  + '<td>周文斌18819340476</td>'
                + '</tr>'
                /*+ '<tr>'
                  + '<td>外联：</td>'
                  + '<td>隋天野13928833643</td>'
                + '</tr>'*/
                + '<tr>'
                  + '<td>广州机场送机工作电话：</td>'
                  + '<td>小周18802038674（留给客人的电话）</td>'
                + '</tr>'
              + '</table>'
              + '<p style="color: white;">（发单后如果还有特殊安排或咨询请联系：工作QQ3379215238或周文斌18819340476）</p>'
              + '<h3 style="font-family: 微软雅黑;"><a href="http://gz.zxsl.net.cn/leanzx/leanzx.html" target="_blank">点击进入：操作视频</a></h3>'
            + '</div>'
          + '</div>'
          /*+ '<div class="col-sm-8">'
              ...
              + '<table id="zx-home-table" class="table table-bordered table-condensed">'
                + '<tbody>'
                  ...
                  + '<tr>'
                    + '<td>四川航空</td>'
                    + '<td>3U</td>'
                    + '<td rowspan="9" style="display:table-cell;vertical-align: middle;text-align:center;font-size:14px;font-family:Microsoft Yahei;">电话：0755-29539901<br>QQ：2246506846<br>调度：郑泽瑜13823550200</td>'
                    + '<td>昆明航空</td>'
                    + '<td>KY</td>'
                  + '</tr>'
                  + '<tr>'
          ...
          + '<div class="col-sm-3 col-sm-offset-1">'
            + '<div style="min-height: 150px;">'
              ...
              + '<ol>'
                + '<li><strong>我们会将所有团队在提前一天办理登机牌（南航、春秋）除外。如果不需要我们提前办理，请在下单的时候告诉小瑜。</strong></li>'
                ...
                + '<li><strong>机场派出所上班时间为7:00-21:00，所以，早班机的客人如果忘带身份证基本就无法登机了。</strong></li>'
                + '<li><strong>错名字：'
                  + '<ul>'
